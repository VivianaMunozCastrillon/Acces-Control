document.addEventListener("DOMContentLoaded", function () {
    ...
    function conectarWebSocket() {
        socket = new WebSocket("ws://192.168.0.2:3000");
        ...
        socket.onmessage = function (event) {
            ...
            if (mensaje.includes("sensor d5 detectó un objeto")) {
            ...
            if (mensaje.includes("sensor d5 sin detección")) {
            ...
            if (mensaje.includes("sensor d6 detectó un objeto")) {
            ...
            if (mensaje.includes("sensor d6 sin detección")) {
