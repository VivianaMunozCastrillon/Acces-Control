...
# Configuración de la ApiKey de OpenAI (usa variables de entorno en producción)
        ...
        async for message in websocket:
            ...
            if message.startswith("sensors:"):
                ...
                if sensor1_estado == 1:
                    ...
                    await send_message_to_clients("Sensor D5 sin detección")

                if sensor2_estado == 1:
                    await send_message_to_clients("Sensor D6 detectó un objeto")
                else:
                    await send_message_to_clients("Sensor D6 sin detección")
